...
CREATE TABLE [dbo].[CORTICON_ANALYTICS_RULE_AUDITING](
	...
	[attribute_old_value] [varchar](100) NULL,
	[attribute_new_value] [varchar](100) NULL,
...
ALTER TABLE [dbo].[CORTICON_ANALYTICS_RULE_AUDITING]  WITH CHECK ADD  CONSTRAINT [FK_CORTICON_ANALYTICS_RULE_AUDITING_RULE_CATALOG] FOREIGN KEY([rule_catalog_id])
REFERENCES [dbo].[CORTICON_ANALYTICS_RULE_CATALOG] ([id])
GO

ALTER TABLE [dbo].[CORTICON_ANALYTICS_RULE_AUDITING] CHECK CONSTRAINT [FK_CORTICON_ANALYTICS_RULE_AUDITING_RULE_CATALOG]
GO
/******************************************************************************************************/
...
ALTER TABLE [dbo].[CORTICON_ANALYTICS_RULE_EXECUTION]  WITH CHECK ADD  CONSTRAINT [FK_CORTICON_ANALYTICS_RULE_EXECUTION_RULE_CATALOG] FOREIGN KEY([rule_catalog_id])
REFERENCES [dbo].[CORTICON_ANALYTICS_RULE_CATALOG] ([id])
GO

ALTER TABLE [dbo].[CORTICON_ANALYTICS_RULE_EXECUTION] CHECK CONSTRAINT [FK_CORTICON_ANALYTICS_RULE_EXECUTION_RULE_CATALOG]
GO
/******************************************************************************************************/
